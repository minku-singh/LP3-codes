#Question - Predict the price of uber ride from a given pickup point to agreed drop-off location.Perform following tasks
# 1. Pre-process the dataset
# 2. Identify outliers
# 3. Check the correlation
# 4. Implement linear regression and random foest regression model
# 5. Evaluate the model and compare their respective scores
#-----------------------------------------------------------------------------------
...
dataset = pd.read_csv('uber.csv')  #save this uber.csv dataset in local computer
