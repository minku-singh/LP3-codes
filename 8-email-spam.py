#Question - Classify the email using binary classsification method. Email spam detection has two states
# a. Noraml state - not spam
# b. Abnormal state - spam
# Use k-nearest neighbours and support vector machine for classification. Analyze their peformance
# ---------------------------------------------------------------------------\
