# Question - Implement k nearest neighbour algorithm on diabetes.csv dataset. Compute confusion matrix, accuracy, error rate, precision and recall on given dataset
#---------------------------------------------------------------------------
...
dataset = pd.read_csv('diabetes.csv')  #save this dataset on local computer
